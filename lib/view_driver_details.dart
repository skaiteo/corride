...
class ViewDriverDetails extends StatelessWidget {
  ...
  ViewDriverDetails({this.reqId, this.driver, this.trip});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListView(
        ...
        children: <Widget>[
          _buildHeader(context, driver.name, trip.destination,
              "${trip.startDate.year}/${trip.startDate.month}/${trip.startDate.day} to ${trip.endDate.year}/${trip.endDate.month}/${trip.endDate.day}"),
          _buildContactCard(driver.phoneNo, driver.email),
  ...
  Future _showAcceptAlertDialog(BuildContext context, bool isAccepted) async {
    await showDialog(
      context: context,
              ...
              Container(
                ...
                child: CircleAvatar(
                  ...
                  backgroundImage: NetworkImage(
                      'https://api.adorable.io/avatars/256/${driver.name}.png'),
                ),
              ),
              Padding(
                padding: EdgeInsets.all(5.0),
            ...
            child: Row(
              ...
              children: <Widget>[
                ButtonTheme(
                  ...
                  child: RaisedButton(
                    onPressed: () async {
                      ...
                      await _showAcceptAlertDialog(context, true);
                ...
                ButtonTheme(
                  ...
                  child: RaisedButton(
                    onPressed: () async {
                      await _showAcceptAlertDialog(context, false);
                      Navigator.of(context).pop(true);
                    },
